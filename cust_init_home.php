					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<!--<li><a href="" id="mydetails" style="display:none;">Artist Profile</a></li>
								<li><a href="design_upload.html" id="upload_design" style="display:none;">Upload New Design</a></li>-->
							</ul>
						</div>
					</div>
					<div class="col-sm-3">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									...
									<h2></h2>
									<p>Bringuing Technic To Ethnic</p>
...
?>						
    ...
    <script type="text/javascript">
    	...
    	function popupitem(imgid){
    		document.getElementById("i3op").style.display = "block";
