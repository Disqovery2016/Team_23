				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><p style="font-size:25px;">FairArt</p></a>
						</div>
					</div>
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li id="wish"><a href="#"><i class="fa fa-star"></i> Wishlist</a></li>
								<li id="checkout"><a href="checkout.html"><i class="fa fa-crosshairs"></i> Checkout</a></li>
								<li id="cart"><a href="cart.html"><i class="fa fa-shopping-cart"></i> Cart</a></li>
